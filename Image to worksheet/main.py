"""
#########################################################################
# PNG2XLSX using Python and OpenPyXL library                            #
...
im = Image.open(r'C:\Users\domen\OneDrive\Documenti\PythonProjects\Image to worksheet\image.png')
...
def generateSheet():
    ...
    # Save the file inside the Image to worksheet folder
    wb.save(r'C:\Users\domen\OneDrive\Documenti\PythonProjects\Image to worksheet\image.xlsx')
